...
export const HASHLINE_WORKFLOW = "Workflow: hashline_read(path) → copy HASH anchors from output → hashline_edit(path, start_hash, end_hash, replacement). Do not use plain read for edits.";
...
function formatOkText(fp, changedRange, dryRun, warnings) {
    ...
    let text = changedRange[1] < changedRange[0]
